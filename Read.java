...
public class Read extends Statement
{
    ...
    public Read(ArrayList<Token> tokens, int start, int end)
    {
    ...
    public boolean check()
    {
        ...
        if ( tokens.get(start++).getMeaning() != 7 )
            return returnFalse();
    ...
    private boolean checkIdList( )
    {
        ...
        //moshkela hena em check valid id msh betla2y el id fl idlist.arrid
    ...
    public void generateCode()
    {
        ...
        Rule.writer.println("EXTREF\tXREAD");
        Rule.writer.println("+JSUB\tXREAD");
